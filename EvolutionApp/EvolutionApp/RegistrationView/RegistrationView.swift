...
class RegistrationView: UIViewController, UITextFieldDelegate {
    ...
    func setupBackground() {
        backgroundImageView.image = UIImage(named: "RegistrationViewImage")
    ...
    func createAgeLabel() {
        ...
        enterAgeLabel.textColor = UIColor.black
    ...
    func activeConstraints() {
        NSLayoutConstraint.activate([
            ...
            genderSegmentControl.trailingAnchor.constraint(equalTo: nameTextField.trailingAnchor),
            ...
            agePicker.trailingAnchor.constraint(equalTo: emailTextField.trailingAnchor),
